  ...
  return (
    <div className="flex h-screen bg-[#f7f7f5] overflow-hidden">
      ...
      <aside className={`
        ...
        w-56 bg-[#070707] flex flex-col h-full
      ...
      `}>
        ...
        <div className="px-5 py-5 border-b border-[#1a1a1a]">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <div className="font-['Barlow_Condensed'] font-bold text-white text-base tracking-wide uppercase leading-none">
                Respawn
              </div>
        ...
        <div className="p-4 border-t border-[#1a1a1a]">
          <button
            onClick={logout}
            className="flex items-center gap-3 w-full px-1 py-2 text-sm text-[#666] hover:text-[#DC2626] transition-colors"
          >
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="bg-white border-b border-[#e8e8e8] px-5 py-3 flex items-center gap-4 flex-shrink-0">
          <button
            ...
            className="lg:hidden text-[#666] hover:text-[#070707]"
          >
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="font-medium text-[#070707]">{currentPage?.label || 'Settings'}</span>
          </div>
          ...
          <div className="ml-auto flex items-center gap-3">
            ...
            <div className="w-7 h-7 bg-[#16C4BA] flex items-center justify-center">
              <span className="text-xs font-bold text-[#070707]">F</span>
            </div>
          </div>
        </header>
...
export function PageHeader({ title, subtitle, actions }: PageHeaderProps) {
  return (
    <div className="flex items-start justify-between mb-6">
      <div>
        <h1 className="font-['Barlow_Condensed'] text-3xl font-bold text-[#070707] uppercase tracking-wide">
          {title}
        </h1>
